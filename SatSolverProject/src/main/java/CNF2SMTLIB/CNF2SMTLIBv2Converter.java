package CNF2SMTLIB;// Original author: Sang Phan ( http://www.andrew.cmu.edu/user/qsp/ )
//
// See https://github.com/qsphan/smt-utils
...
public class CNF2SMTLIBv2Converter {
	...
	public String convertDimacs(String cnf) {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(cnf))) {
			...
			smt2 = getSMTLIB2Info() + getDeclaration() + formula;
